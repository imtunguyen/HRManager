...
namespace HR_Manager
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			button4.Location = new Point(7, 540);
			...
			button3.Location = new Point(7, 234);
			...
			btnEmployee.Location = new Point(7, 20);
			...
			tableLayoutPanel1.Size = new Size(229, 613);
			...
			button5.Location = new Point(7, 341);
			...
			btnManagement.Location = new Point(7, 448);
