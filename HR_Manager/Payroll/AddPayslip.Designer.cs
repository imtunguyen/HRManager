namespace HR_Manager.Payroll
{
	partial class AddPayslip
	{
		...
		private void InitializeComponent()
		{
			...
			groupBox1.Location = new Point(46, 363);
			...
			lblPaid.Location = new Point(226, 29);
			lblPaid.Name = "lblPaid";
			lblPaid.Size = new Size(42, 23);
			lblPaid.TabIndex = 8;
			lblPaid.Text = "Paid";
			...
			lblRunning.Location = new Point(125, 29);
			lblRunning.Name = "lblRunning";
			lblRunning.Size = new Size(68, 23);
			...
			lblDraft.Location = new Point(40, 29);
			lblDraft.Name = "lblDraft";
			lblDraft.Size = new Size(48, 23);
			lblDraft.TabIndex = 6;
			lblDraft.Text = "Draft";
			// 
			// btnDone
			...
			btnDone.Location = new Point(978, 530);
			...
			btnSubmit.Location = new Point(96, 530);
			...
			textBox3.Location = new Point(686, 98);
			...
			label3.Location = new Point(555, 105);
			label3.Name = "label3";
			...
			textBox1.Location = new Point(163, 308);
			...
			button2.Location = new Point(853, 98);
			...
			dateTimeFrom.Location = new Point(163, 187);
			dateTimeFrom.Margin = new Padding(3, 4, 3, 4);
			dateTimeFrom.Name = "dateTimeFrom";
			dateTimeFrom.Size = new Size(270, 27);
			...
			label14.Location = new Point(46, 192);
			...
			label15.Location = new Point(46, 257);
			...
			dateTimeTo.Location = new Point(163, 250);
			dateTimeTo.Margin = new Padding(3, 4, 3, 4);
			dateTimeTo.Name = "dateTimeTo";
			dateTimeTo.Size = new Size(270, 27);
			...
			cbEmployee.Location = new Point(163, 123);
			cbEmployee.Margin = new Padding(3, 4, 3, 4);
			cbEmployee.Name = "cbEmployee";
			cbEmployee.Size = new Size(270, 28);
			...
			textBox2.Location = new Point(223, 492);
			...
			label13.Location = new Point(131, 492);
			...
			button1.Location = new Point(916, 26);
			...
			dataGridView1.Location = new Point(502, 150);
			dataGridView1.Name = "dataGridView1";
			dataGridView1.RowHeadersWidth = 51;
			dataGridView1.RowTemplate.Height = 29;
			dataGridView1.Size = new Size(599, 362);
