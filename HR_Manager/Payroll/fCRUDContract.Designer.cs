namespace HR_Manager.Payroll
{
	partial class fCRUDContract
	{
		...
		private void InitializeComponent()
		{
			...
			timeStart.Location = new Point(203, 180);
			...
			timeEnd.Location = new Point(203, 244);
			...
			txtName.Location = new Point(203, 107);
			...
			cbStatus.Location = new Point(843, 241);
			...
			tabControl1.Size = new Size(1061, 215);
			...
			tabPage1.Size = new Size(1053, 182);
			tabPage1.TabIndex = 0;
			...
			tabPage2.Size = new Size(1053, 182);
			tabPage2.TabIndex = 1;
			...
			// num
			// 
			num.Location = new Point(306, 107);
			...
			label12.Location = new Point(462, 107);
			...
			btnLuu.Location = new Point(997, 524);
			btnLuu.Name = "btnLuu";
