namespace HR_Manager.Employee
{
	partial class Employee
	{
		...
		private void InitializeComponent()
		{
			...
			// tabPage4
			// 
			tabPage4.Controls.Add(jobDetailUserControl);
			tabPage4.Location = new Point(4, 34);
			tabPage4.Name = "tabPage4";
			tabPage4.Padding = new Padding(3);
			tabPage4.Size = new Size(992, 562);
			tabPage4.TabIndex = 7;
			tabPage4.Text = "Job Detail";
			tabPage4.UseVisualStyleBackColor = true;
			//
			jobDetailUserControl.Location = new Point(0, 3);
			jobDetailUserControl.Margin = new Padding(3, 4, 3, 4);
			jobDetailUserControl.Name = "jobDetail";
			jobDetailUserControl.Size = new Size(980, 456);
