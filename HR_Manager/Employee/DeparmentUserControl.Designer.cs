...
namespace HR_Manager
{
	partial class DepartmentUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			tableLayoutPanel1.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 381F));
			...
			button1.Location = new Point(483, 4);
			button1.Margin = new Padding(3, 4, 3, 4);
			button1.Name = "button1";
			button1.Size = new Size(112, 77);
			button1.TabIndex = 0;
			button1.Text = "ADD";
			...
			textBox1.Location = new Point(646, 29);
			...
			label3.Location = new Point(165, 12);
			label3.Name = "label3";
